...
<!-- Modal -->
                ...
                <div class="col-lg-7 mt-5">
                    <div class="card">
                        <div class="card-body" data-id="${product.id}">
                            ...
                            <p class="h3 py-2"><f:formatNumber value="${product.price}" type="currency"/></p>
                            <p class="py-2">
                            ...
                            <ul class="list-inline">
                                ...
                                <li class="list-inline-item">
                                    <p class="text-muted"><strong>Street Style</strong></p>
                                </li>
                            </ul>
	...
	<div class="container">
     ...
     <div class="alert alert-warning alert-dismissible fade show justify-content-center d-flex"  style="margin-left:13%; margin-top:20px;background-color:black; color:white">
	    
	    <strong> Đăng nhập và mua sản phẩm để có thể bình luận</strong>
  	</div>
        <div class="detailBox justify-content-center">
            <div class="commentBox text-center">
                
                <p class="taskDescription">Phản hồi khách hàng</p>
            </div>
            <div class="actionBox">
...
$(document).ready(function(){
	 ...
	 // related product detail request
	 ...
	 // slick the carousel related product
