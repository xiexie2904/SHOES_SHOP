					...
					<div class="col-lg-6 col-sm-6 col-12">
						<div class="form-group">
							...
							<form:input path="code" class="form-control"
								id="validationCustom01" placeholder="CODE" />

							<div class="invalid-feedback">Please provide a valid code.
							</div>
						</div>
					</div>
					<div class="col-lg-6 col-sm-6 col-12">
						<div class="form-group">
							...
							<form:input path="name" class="form-control"
								id="validationCustom02" placeholder="name" />
					...
					<div class="col-lg-6 col-sm-6 col-12">
						<div class="form-group">
							...
							<form:input path="quantity" class="form-control"
								id="validationCustom02" placeholder="quantity" />
					...
					<div class="col-lg-6 col-sm-6 col-12">
						<div class="form-group">
							...
							<form:input path="sale" class="form-control"
								id="validationCustom02" placeholder="sale" />
							<div class="invalid-feedback">Please provide a valid sale.
							</div>
						</div>
					</div>
				 <div class="col-lg-6 col-sm-6 col-12">
              <div class="form-group">
                <label class="text-inverse" for="select-menu">Select category</label>
                ...
                <c:forEach items="${categories}" var="category">
							...
							<div class="invalid-feedback">Please selected any option.</div>
						</div>
					</div>
				</div>
				<div class="row">
...
</svg> <span class="custom-file-control"> Please selected image product</span>
								<div class="invalid-feedback">Please selected any File.</div>
							</label>
						</div>
					</div>
					<div class="col-lg-6 col-sm-6 col-12">
