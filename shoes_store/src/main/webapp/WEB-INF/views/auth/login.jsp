                        ...
                        <form:form method="post" modelAttribute="account" action="login" enctype="multipart/form-data">
                            ...
                            <div class="col-lg-12 loginbttm">
                                ...
                                <div class="col-lg-6 login-btm login-button">
                                	<a href="<c:url value="/" />" class="btn btn-outline-success" role="button">Trang chủ</a>
                                    <button type="submit" class="btn btn-outline-primary" value="login">Đăng nhập</button>
                                    <a href="<c:url value="/register" />" class="btn btn-outline-info" role="button">Đăng ký</a>
                                </div>
                            </div>
                        </form:form>
