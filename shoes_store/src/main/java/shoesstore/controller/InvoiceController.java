...
public class InvoiceController {
	...
	public String showImportProduct(@PathVariable("id") int id, Model model, HttpSession session,HttpServletRequest req) {
		while(session.getAttribute("usernameAdmin") != null) {
			String p_url = "" + req.getScheme() + "://"
				    + req.getServerName()
				    + ":" + req.getServerPort()
				    + req.getContextPath();
			model.addAttribute("url", p_url+"/invoice/import/" + id);
